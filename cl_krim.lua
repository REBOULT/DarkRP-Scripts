...
local function Openmenu()
    ...
    MainPanel_OKKKKKKK.Paint = function(me, w, h)
        ...
        draw.SimpleText("Наёмник", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK.DoClick = function()
        RunConsoleCommand("darkrp", "naim")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK2.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Оружейник", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK2.DoClick = function()
        RunConsoleCommand("darkrp", "darkgundealer")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK3.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Табачник", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK3.DoClick = function()
        RunConsoleCommand("darkrp", "narko")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end

    local MainPanel_OKKKKKKK4 = vgui.Create('DButton', MainPanel)
    MainPanel_OKKKKKKK4:SetSize(412, 84)
    -- право право <|> лево лево --
    MainPanel_OKKKKKKK4:SetPos(600, 190)
    MainPanel_OKKKKKKK4:SetText('')

    MainPanel_OKKKKKKK4.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Вор", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK4.DoClick = function()
        RunConsoleCommand("darkrp", "thieff")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    local MainPanel_OKKKKKKK5 = vgui.Create('DButton', MainPanel)
    MainPanel_OKKKKKKK5:SetSize(412, 84)
    -- право право <|> лево лево --
    MainPanel_OKKKKKKK5:SetPos(600, 70)
    MainPanel_OKKKKKKK5:SetText('')

    MainPanel_OKKKKKKK5.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Бандит", "Button", w / 2.00, h / 2.60, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK5.DoClick = function()
        RunConsoleCommand("darkrp", "gangster")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    local MainPanel_OKKKKKKK6 = vgui.Create('DButton', MainPanel)
    MainPanel_OKKKKKKK6:SetSize(412, 84)
    -- право право <|> лево лево --
    MainPanel_OKKKKKKK6:SetPos(130, 70)
    MainPanel_OKKKKKKK6:SetText('')

    MainPanel_OKKKKKKK6.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Наркоман", "Button", w / 2.00, h / 2.60, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK6.DoClick = function()
        RunConsoleCommand("darkrp", "mef")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
...
concommand.Add("krim_menu", Openmenu)
