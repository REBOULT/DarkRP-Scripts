...
local function Openmenu()
    ...
    MainPanel_OKKKKKKK.Paint = function(me, w, h)
        ...
        draw.SimpleText("Безработный", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK.DoClick = function()
        RunConsoleCommand("darkrp", "igrok")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK2.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Бездомный", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK2.DoClick = function()
        RunConsoleCommand("darkrp", "hobo")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK3.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Рыбак", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK3.DoClick = function()
        RunConsoleCommand("darkrp", "rbibak")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK4.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Врач", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK4.DoClick = function()
        RunConsoleCommand("darkrp", "medic")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK5.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Банкир", "Button", w / 2.00, h / 2.60, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK5.DoClick = function()
        RunConsoleCommand("darkrp", "banker")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK6.Paint = function(self, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Авто-механик", "Button", w / 2.00, h / 2.60, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK6.DoClick = function()
        RunConsoleCommand("darkrp", "remont")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
...
concommand.Add("mir_menu", Openmenu)
