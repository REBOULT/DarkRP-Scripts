...
local function Openmenu()
    ...
    MainPanel_OKKKKKKK.Paint = function(me, w, h)
        ...
        draw.SimpleText("Полиция", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK.DoClick = function()
        RunConsoleCommand("darkrp", "cp")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK2.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Шеф полиции", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK2.DoClick = function()
        RunConsoleCommand("darkrp", "chiefcp")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK3.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("Агент ФБР", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK3.DoClick = function()
        RunConsoleCommand("darkrp", "fbi")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
    end
    ...
    MainPanel_OKKKKKKK4.Paint = function(me, w, h)
        draw.RoundedBox(7, 0, 1, w, h, buttonColor)
        draw.SimpleText("S.W.A.T", "Button", w / 2.00, h / 2.30, gay, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end

    MainPanel_OKKKKKKK4.DoClick = function()
        RunConsoleCommand("darkrp", "swat")
        MainPanel:AlphaTo(0, 0.2, 0, function()
            MainPanel:Remove()
        end)
...
concommand.Add("gos_menu", Openmenu)
