...
RunConsoleCommand("ent_remove_all", "ambient_generic") 
RunConsoleCommand("nt_remove_all", "env_soundscape") 
RunConsoleCommand("ent_remove_all", "env_soundscape_triggerable") 
RunConsoleCommand("playsoundscape", "Nothing") 
